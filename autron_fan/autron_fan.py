...
AUTRON_URL = 'https://beta-doraemon-cms.appspot.com/ultronsmart/ReportState'
HEADER = {'Authorization': 'Bearer xT2UrtTWCxUrUNYw8HNfCo29S7orNG2ncKu3hh7JRFKhSnrpwN25f7WvFs1mwbabEgtf'}

HERAN_URL = 'http://www.iot.jowinwin.com/iot_mid/Inside_find.php'
VAL = {'pass': "heran open and go"}
...
def initialization_status():
    for fan_mac, users in mac_dict.items():
        ...
        fan_status[fan_mac] = {'on': False, 'mode1': '1', 'speed_mode2': '1', 'sway_toggle1': False, 'online': False,
                               ...
                               'autron_init': False, 'light_mode3': '1', 'eco': 0}
        for user in users:
